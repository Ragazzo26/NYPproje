...
namespace NYPproje.DAL
{
    internal class ProductDAO
    {
        internal void kaydet(Product gProduct)
        {
            ...
            baglanti.Open();
            new MySqlCommand("insert into Product (urunAdi, urunAdet, urunFiyat, minStok) value ('" + gProduct.UrunAdi + "', " + gProduct.UrunAdet + ", " + gProduct.UrunFiyat + ", urunMaliyet="+gProduct.UrunMaliyet+" , " + gProduct.MinStock + ")", baglanti).ExecuteNonQuery();
            baglanti.Close();
        }
